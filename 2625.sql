...
-- Your company's communications managers want a report on the natural person customer data 
-- that is registered in the database. But the old report had a problem. customers CPF data came without validation.
