...
-- the computer responsible for processing the candidates' data is broken. 
-- You must present the candidate list, containing the name and final score 
-- (with two decimal places of precision) of each candidate. Remember to show 
...
-- Remember -> Avg = (math * 2) + (specific * 3) + (project_plan * 5) / 10
